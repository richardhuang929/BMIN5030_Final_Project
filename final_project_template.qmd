...
Subgroup analyses showed that the positive association between TG/HDL-C and 4-year cognitive impairment was generally consistent across age and BMI categories, with no statistically significant interaction detected (all p-interaction \>0.26). Among participants younger than 75 years, higher TG/HDL-C was associated with increased risk (OR = 1.11, 95% CI: 1.02–1.19), similar in magnitude to adults aged ≥75 years (OR = 1.08, 95% CI: 0.92–1.24). Patterns were also stable across BMI strata, with ORs ranging from 1.05 to 1.17. In contrast, heterogeneity was observed by sex (p-interaction = 0.006) and education level (p-interaction \< 0.001). Women demonstrated a stronger association (OR = 1.12, 95% CI: 1.02–1.22) than men (OR = 1.06, 95% CI: 0.94–1.19). Similarly, participants with middle/high school education showed clearer risk elevation (OR = 1.15, 95% CI: 1.05–1.25), whereas those with higher education did not exhibit a significant association (OR = 0.96, 95% CI: 0.74–1.15). Overall, while TG/HDL-C was positively associated with cognitive impairment in several subgroups, the strength of the association varied notably by sex and educational attainment.
